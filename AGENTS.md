...
- **Documentação**: **100% aprovada** em 2026-08-13 — `docs/DESIGN.md` v0.7 (direção visual) e `docs/specs/SPEC-frontend.md` v0.2 (design system técnico) aprovados. Única exceção: `SPEC-mobile.md` ([IDEALIZAÇÃO], fora do escopo).
